...
public extension ALTAppPermissionType
{
    ...
    var icon: UIImage? {
        ...
        case .backgroundAudio: return UIImage(systemName: "speaker")
        case .backgroundFetch: return UIImage(systemName: "square.and.arrow.down")
        case .bluetooth: return UIImage(systemName: "wave.3.right") // TODO: Replace with bluetooth icon
        ...
        case .siri: return UIImage(systemName: "mic.and.signal.meter") // TODO: Replace with siri icon
